...
const entityListContractAddress = '0xbF3bcc9FB387561053a6D1bcF080436c01992e7f';
// tslint:disable-next-line:max-line-length
const entityListContractAbi = [ { 'constant': true, 'inputs': [ { 'name': '', 'type': 'uint256' } ], 'name': 'providingAuthorities', 'outputs': [ { 'name': 'name', 'type': 'string' }, { 'name': 'addr', 'type': 'address' } ], 'payable': false, 'stateMutability': 'view', 'type': 'function' }, { 'inputs': [], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'constructor' }, { 'constant': false, 'inputs': [ { 'name': 'x', 'type': 'address' } ], 'name': 'toString', 'outputs': [ { 'name': '', 'type': 'string' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function' }, { 'constant': false, 'inputs': [ { 'name': 'addr', 'type': 'address' } ], 'name': 'addAdmin', 'outputs': [ { 'name': '', 'type': 'string' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function' }, { 'constant': false, 'inputs': [ { 'name': 'name', 'type': 'string' }, { 'name': 'addr', 'type': 'address' } ], 'name': 'addProvidingAuthority', 'outputs': [ { 'name': '', 'type': 'string' } ], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function' } ];
...
export class LoginService {
  ...
  async checkEntityList() {
    ...
    console.log(await entityListContract.providingAuthorities.call(0));
  }
