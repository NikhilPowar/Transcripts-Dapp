...
export class TransactionService {
  ...
  dummyTransaction() {
    ...
    // console.log(tx);
    // tx.then(success => console.log(success));
  ...
  async sendThroughID(to: string, value: number, data: string) {
    ...
    idContract.on('ExecutionRequested', (id, _to, _value, _data, event) => {
      console.log('ID: ', id);
      console.log('to: ', _to);
    ...
    idContract.on('Approved', (id, approved, event) => {
      console.log('ID: ', id);
      console.log('Approved: ', approved);
      console.log('Event: ', event);
    });
    idContract.on('Executed', (id, _to, _value, _data, event) => {
      console.log('ID: ', id);
      console.log('to: ', _to);
      console.log('value: ', _value);
      console.log('Data: ', _data);
    ...
    // idContract.on('ExecutionFailed', (id, _to, _value, _data, event) => {
    //   console.log('ID: ', id);
    //   console.log('to: ', _to);
    //   console.log('value: ', _value);
    //   console.log('Data: ', _data);
    //   console.log('Event: ', event);
    // });
    const execID = await idContract.execute(to, value, data);
    console.log(execID);
    console.log(await execID.wait());
  }
}
